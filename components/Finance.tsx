...
const FinanceTracker = () => {
  ...
  useEffect(() => {
    const gotUserData = loadCurrentUser();
    if (gotUserData) {
      setUser(gotUserData);
      loadTransactions(gotUserData.id);
      loadBudgets(gotUserData.id);
    } else {
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-2xl p-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
                  <input
                    ...
                    onKeyPress={(e) => handleKeyPress(e, addTransaction)}
              ...
              <div className="bg-indigo-50 border border-indigo-100 rounded-2xl p-6 shadow-inner">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <input
                    ...
                    onKeyPress={(e) => handleKeyPress(e, addBudget)}
